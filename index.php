      ...
      <nav class="navbar navbar-expand-md bg-dark navbar-dark">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
          <div class="navbar-nav mr-auto text-center">
            <a href="index.html" class="nav-item nav-link active"><i class="fa fa-home"></i> หน้าหลัก</a>
                    ...
                    <form action="#">
                      ...
                      <div class="col-mg-12 text-center">
                        <button type="button" class="btn"
                          style="border-radius: 18px;background-color: #D9A774;color: #000;" data-toggle="modal"
                          data-target="#register">สมัครสมาชิก
                        </button>
                      </div>
                    </form>
                  </div>
                    ...
                    <form action="#">
                      ...
                      <div class="form-check">
                        <label class="form-check-label">
                          ...
                          <p><a href="#">ยอมรับ</a>เงื่อนไขในการเข้าถึงของคุณ และเว็บไซต์ของเรา</p>
                        </label>
                      </div>
                      <div class="col-mg-12 text-center">
        ...
        <div class="text-center">
          <div class="row">
            ...
            <div class="col-md-5 col-ms-12">
              <div class="qrcode">
                <img src="img/136141256_292659638949389_6530700372343233245_n.jpg" alt="QR Code" class="img-thumbnail"
                  style="width: 50%;">
              </div>
            </div>
          </div>
    ...
    <div class="row">
        ...
        <div id="Article" class="w3-container Tabs content box-shadow">
          <div class="slider">
            <div class="row align-items-center slider-3">
              <div class="column">
                <div class="card">
                  <img src="https://www.w3schools.com/w3images/mountains.jpg" alt="Jane" style="width:100%">
                  <div class="container">
                    <h2>Jane Doe1</h2>
              ...
              <div class="column">
                <div class="card">
                  <img src="https://www.w3schools.com/w3images/lights.jpg" alt="Jane" style="width:100%">
                  <div class="container">
                    <h2>Jane Doe2</h2>
                    <p class="title">CEO & Founder</p>
                    <p>Some text that describes me lorem ipsum ipsum lorem.</p>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="col">
          ...
          <div class="row align-text-center btn-box">
          ...
          <a href="#">
            <div class="media media-law box-shadow">
              <img class="card-img-top" src="img/20200513d41d8cd98f00b204e9800998ecf8427e094310.png"
                alt="Card image cap">
